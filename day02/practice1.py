...
print("당신의 영문 이름은 [ " , len(input("영문 이름을 입력 > ")), " ] 글자입니다.")

# 문제 7: 성과 이름 분리 "홍 길동"과 같이 공백이 포함된 이름을 입력받아, 인덱싱과 슬라이싱을 사용하여 성(첫 글자)만 출력하시오.
name = input('성과 이름을 띄워 입력 > ')
print("당신의 성: ", name[0 : 2])
...
i = 10
j = 2.0
print(i/j, "의 타입: ", type(i/j))  # 5.0 의 타입:  <class 'float'>
